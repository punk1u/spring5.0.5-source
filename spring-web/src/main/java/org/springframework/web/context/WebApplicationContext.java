 ...
 *
 * 这个接口增加了getServletContext方法用来获取存储在具体实现类中的ServletContext对象
 ...
 *
 * 与一般的应用程序上下文一样，web应用程序上下文也是分层的。每个应用程序都有一个根上下文，
 * 而应用程序中的每个servlet（包括MVC框架中的dispatcher servlet）都有自己的子上下文。
 ...
 *
 * 除了标准的应用程序上下文生命周期功能之外，
 * WebApplicationContext实现还需要检测{@link ServletContextAware} bean对象
 * 并相应地调用其中的{@code setServletContext}方法。
 *
